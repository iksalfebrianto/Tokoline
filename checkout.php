...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?= $_SESSION['name'] ?> telah membeli <?php echo $itungtrans3 ?> barang di Tokoline</span></h1>
		...
		<br>
		<center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp. 10.000</h2>
